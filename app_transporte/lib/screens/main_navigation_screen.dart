...
/// Menu simétrico, com 4 abas equilibradas e 100% responsivas para qualquer tela (mobile, tablet, desktop).
        ...
        child: SafeArea(
          ...
          child: Stack(
            children: [
              ...
              // 2. Floating Glass Bottom Navigation Bar (Responsiva: full em mobile, centrada em tablet/desktop)
              Positioned(
                left: 0,
                right: 0,
                bottom: 14,
                child: Center(
                  child: ConstrainedBox(
                    constraints: BoxConstraints(
                      maxWidth: math.min(screenWidth - 24, 480),
                    ),
                    child: GlassContainer(
                      borderRadius: 24,
                      blurSigma: 20,
